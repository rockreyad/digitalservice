          ...
          <div className="flex space-x-2">
            <div className="flex flex-col">
              <h1 className="text-xl font-semibold">
                Order <span className="font-light"> #17278</span>
              </h1>
              <p className="text-gray-500 text-sm">2 May 2023 at 12:00 PM</p>
            </div>
            <div>
              <Badge className="" variant="subtle" colorScheme="green">
                paid
              </Badge>
            </div>
          </div>
        ...
        <main className="grid grid-flow-col grid-rows-2 grid-cols-1 md:grid-cols-3 md:grid-flow-row gap-2">
          <div className="md:col-start-1 md:col-end-3 space-y-5">
            <div className="bg-white p-4 rounded-md">
              <div>
                <h1 className="text-xl font-medium">Customer&apos;s cart</h1>
                <p>Sevice list</p>
              </div>
              <ul className="p-2">
          ...
          <div className="bg-white p-4 h-fit">
            <div className="">
              <h1 className="text-xl font-medium">Customer Information</h1>
