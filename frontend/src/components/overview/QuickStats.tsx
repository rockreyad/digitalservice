...
const QuickStats = () => {
  return (
    <div className="bg-white px-3 py-3 w-fit space-y-7 border-2 border-gray-100 rounded-md">
      ...
      <div className="bg-black px-3 py-2 space-x-10 flex justify-between rounded-md">
